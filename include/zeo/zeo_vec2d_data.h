...
#define zVec2DDataCapacity(data) zVecXDDataCapacity(data)
...
/*! \brief a naive algorithm to find vicinity of a point in a set of 2D vectors. */
__ZEO_EXPORT ZEO_VECXD_DATA_VICINITY_PROTOTYPE( 2D );

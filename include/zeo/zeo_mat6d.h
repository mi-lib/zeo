...
__ZEO_EXPORT zMat6D *zMat6DZero(zMat6D *m);
...
__ZEO_EXPORT zMat6D *zMat6DT(const zMat6D *m, zMat6D *mout);
...
__ZEO_EXPORT zMat6D *zMat6DAdd(const zMat6D *m1, const zMat6D *m2, zMat6D *m);
...
__ZEO_EXPORT zMat6D *zMat6DSub(const zMat6D *m1, const zMat6D *m2, zMat6D *m);
...
__ZEO_EXPORT zMat6D *zMat6DMul(const zMat6D *m, double k, zMat6D *mm);

/*! \brief divide a 6x6 matrix by a scalar value.
 * \a m = 1/\a k \a m
 */
__ZEO_EXPORT zMat6D *zMat6DDiv(const zMat6D *m, double k, zMat6D *dm);
...
__ZEO_EXPORT zMat6D *zMat6DAddDRC(zMat6D *m1, const zMat6D *m2);
...
__ZEO_EXPORT zMat6D *zMat6DSubDRC(zMat6D *m1, const zMat6D *m2);
...
__ZEO_EXPORT zMat6D *zMat6DMulDRC(zMat6D *m, double k);
__ZEO_EXPORT zMat6D *zMat6DDivDRC(zMat6D *m, double k);

/*! \brief multiply a 6x1 vector by a 6x6 matrix from the left side.
 * \a vout = \a m \a vin
 */
__ZEO_EXPORT zVec6D *zMulMat6DVec6D(const zMat6D *m, const zVec6D *vin, zVec6D *vout);

/*! \brief multiply a 6x1 vector by the transpose of a 6x6 matrix from the left side.
 * \a vout = \a m^T \a vin
 */
__ZEO_EXPORT zVec6D *zMulMat6DTVec6D(const zMat6D *m, const zVec6D *vin, zVec6D *vout);

/*! \brief multiply a 6x6 matrix by another.
 * \a m = \a m1 \a m2
 */
__ZEO_EXPORT zMat6D *zMulMat6DMat6D(const zMat6D *m1, const zMat6D *m2, zMat6D *m);

/*! \brief multiply a 6x6 matrix by the transpose of another from the left side.
 * \a m = \a m1^T \a m2
 */
__ZEO_EXPORT zMat6D *zMulMat6DTMat6D(const zMat6D *m1, const zMat6D *m2, zMat6D *m);

/*! \brief multiply a 6x6 matrix by the transpose of another from the right side.
 * \a m = \a m1 \a m2^T
 */
__ZEO_EXPORT zMat6D *zMulMat6DMat6DT(const zMat6D *m1, const zMat6D *m2, zMat6D *m);
...
__ZEO_EXPORT zMat6D *zMat6DDyad(zMat6D *m, const zVec6D *v1, const zVec6D *v2);

/*! \brief print a 6x6 matrix out to a file. */
__ZEO_EXPORT void zMat6DFPrint(FILE *fp, const zMat6D *m);

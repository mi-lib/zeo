...
static zMat3D *_zShape3DPHInertia(void *body, zMat3D *i){
  return zPH3DInertia( body, i ); }
static void _zShape3DPHBaryInertia(void *body, zVec3D *c, zMat3D *i){
  zPH3DBaryInertia( body, c, i ); }

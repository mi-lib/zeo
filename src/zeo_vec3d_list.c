...
zVec3DAddrListCell *zVec3DAddrListAdd(zVec3DAddrList *list, const zVec3D *v)
{
  zVec3DAddrListCell *cell;

  if( !( cell = zAlloc( zVec3DAddrListCell, 1 ) ) ){
    ZALLOCERROR();
    return NULL;
  }
  cell->data = (zVec3D*)v;
...
zListQuickSortDef( zVec3DAddrList, zVec3DAddrListCell )
